...
export default function SkinHero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from("[data-animate='badge']", {
        ...
        .from(
          "[data-animate='video']",
          { y: 40, opacity: 0, scale: 0.96, duration: 0.75 },
          "-=0.4",
        )
        .from(
          "[data-animate='card']",
          { x: 24, opacity: 0, scale: 0.97, duration: 0.45, stagger: 0.08 },
          "-=0.4",
        );
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen lg:mt-6 w-full max-w-[1800px] items-start px-4 pt-24 sm:px-6 md:px-8 lg:px-10 xl:px-12">
