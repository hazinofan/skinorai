...
export default function ProductScanShowcase() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#f7f7f8] mt-6">
      <div className="">
        <div className="overflow-hidden bg-[#d8dadd]">
          <div className="grid min-h-[920px] overflow-hidden bg-white lg:grid-cols-2">
            ...
            >
              <Image
                src="/faceScan.png"
                alt="Analyse skincare personnalisée avec SkinorAI"
                fill
              ...
              <ImageLabel
                className="left-[44%] top-[18%]"
                text="ANALYSER"
              />

              <ImageLabel
                className="left-[39%] top-[50%]"
                text="HYDRATER"
              />

              <ImageLabel
                className="left-[68%] top-[72%]"
                text="COMPRENDRE"
              />
            </div>
            ...
            <div className="relative flex min-h-[440px] flex-col items-center bg-[linear-gradient(180deg,#f3eaff_0%,#faf7ff_52%,#ffffff_100%)] px-6 py-10 text-center sm:px-10 lg:min-h-[520px] lg:px-14 lg:py-12">
              <div data-animate="how-intro" className="max-w-[500px]">
                ...
                <p className="mx-auto mt-4 max-w-[440px] text-sm leading-6 text-[#625c69]">
                  SkinorAI ne promet pas la perfection. Il analyse, apprend et
                  adapte ses recommandations à votre type de peau, vos objectifs
              ...
              <div data-animate="how-outro" className="max-w-[520px]">
                ...
                <p className="mx-auto mt-4 max-w-[460px] text-sm leading-6 text-[#6b6471]">
                  Nous ne pouvons pas arrêter le temps, mais nous pouvons vous
                  aider à mieux comprendre votre peau, choisir vos produits et
                  construire une routine plus adaptée.
                </p>
              </div>
            </div>
          </div>
